...
namespace EDGE.Common
{
	...
	/// </summary>
	///<remarks>
	/// <para>Use WarningMessage to convey that the current execution may be finished but in an altered state.</para>
	/// <para>A WarningMessage should be used for display purposes <b>only,</b>
	...
	[Serializable]
	public class WarningMessage : ExecutionMessage
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public WarningMessage(string text, Type originatorType = null, bool suppressOnSave = false, string messageTypeCode = "")
